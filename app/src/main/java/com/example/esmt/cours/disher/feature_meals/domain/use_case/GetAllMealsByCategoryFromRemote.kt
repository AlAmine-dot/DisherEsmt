...
//
//class GetAllMealsByCategoryFromRemote @Inject constructor(
//    private val repository: MealRepository
//) {
//
//    // C'est juste pour qu'on puisse appeler la classe comme si c'était une fonction
//    suspend operator fun invoke(category: Category?): List<Meal>  {
//
//        return repository.getAllMealsByCategoryFromRemote(category)
//    }
//
//}